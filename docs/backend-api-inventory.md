...
- The native boundary is not considered memory/lifecycle-clean yet. Current
  findings and remediation order are in
...
- Native video restart/read/deinit synchronization and VENC resource ownership
  must be fixed and stress-tested on device 133.
