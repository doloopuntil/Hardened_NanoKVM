...
[ "$(jq -r .source_commit "$tmp/manifest.json")" = 9567b5f ] || fail "manifest source commit"
...
[ "$rootfs_sha" = b840bd08f2c708b45b527d005719b6d5dc6a7b1ba66922b8e161b570a950c760 ] || fail "selected rootfs hash"
