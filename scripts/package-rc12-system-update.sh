...
HARDENED_SG2002_RAW_IMAGES_DIR="$ROOT_DIR/build/latestbuildroot/raw-system-update-0.3.0-raw.12/images" \
HARDENED_SG2002_RAW_UPDATE_OUT="$ROOT_DIR/build/latestbuildroot/raw-system-update-0.3.0-raw.12/artifacts" \
